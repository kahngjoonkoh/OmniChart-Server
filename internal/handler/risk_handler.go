...
// GetBetaHandler godoc
// @Summary      Get beta and risk classification for a stock
// @Description  Retrieves the beta value and risk category of a given ticker symbol using Finnhub API
// @Tags         stocks
// @Produce      json
